...
public class Player1 : MonoBehaviour
{
    ...
    void Death(Collider2D collision)
    {
        ...
        {
            case "BulletAk(Clone)":
                Life1.fillAmount -= 0.09f;
                break;
        }

        if (Life1.fillAmount <= 0)
            Destroy(gameObject);
